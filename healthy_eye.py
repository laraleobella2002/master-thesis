...
fileName = f'amblyopia_data_{participant_name}_healthy_eye.csv'
...
fileName2 = f'amblyopia_data_{participant_name}_healthy_eye_parameters.csv'
...
circle_healthy = visual.Circle(
    ...
    opacity=0.7,
    pos=(dichoptic_offset, 0)
)

square_healthy = visual.Rect(
    win=win,
    width=cross_size * 2,
    height=cross_size * 2,
    lineColor=healthy_eye_color,
    ...
    for trials in range(num_trials):
        ...
        while not trial_successful:
            ...
            vernier1_healthy = visual.Line(
                ...
                start=(current_eccentricity + offset + dichoptic_offset, lineHeight),
                end=(current_eccentricity + offset + dichoptic_offset, 0)
            )
            ...
            vernier2_healthy = visual.Line(
                ...
                lineWidth=lineThickness,
                opacity=matched_contrast,
                start=(current_eccentricity + dichoptic_offset, 0),
                end=(current_eccentricity + dichoptic_offset, -lineHeight)
            )
            ...
            vertical_cross_healthy = visual.Line(
                ...
                lineWidth=cross_width,
                opacity=0.7,
                start=(dichoptic_offset, -cross_size),
                end=(dichoptic_offset, cross_size)
            )
            ...
            horizontal_cross_healthy = visual.Line(
                ...
                lineWidth=cross_width,
                opacity=0.7,
                start=(-cross_size + dichoptic_offset, 0),
                end=(cross_size, 0)
            )
