...
expInfo={ 'participantID': '', 'condition': ''}
dlg = gui.DlgFromDict(dictionary=expInfo, sortKeys=False, title='Vernier Experiment')
participant_name = expInfo['participantID']
session_number = expInfo['condition']


fileName= f'data_{participant_name,session_number}.csv'
